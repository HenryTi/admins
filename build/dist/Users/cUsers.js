...
export class UsersController extends Controller {
    constructor() {
        ...
        this.onAppsClick = (appUsers) => __awaiter(this, void 0, void 0, function* () {
            ...
            let pageStart = 0;
            let pageSize = 100;
            this.curAppUsers = yield mainApi.unitOneAppUsers(this.unitId, this.curApp.id, pageStart, pageSize);
            this.openVPage(VApp);
        });
        this.onUsersClick = (userApps) => __awaiter(this, void 0, void 0, function* () {
            ...
            let pageStart = 0;
            let pageSize = 100;
            this.curUserApps = yield mainApi.unitOneUserApps(this.unitId, this.curUser.id, pageStart, pageSize);
            this.openVPage(VUser);
        });
        this.onAppEditUsers = (key) => __awaiter(this, void 0, void 0, function* () {
            let pageStart = 0;
            let pageSize = 100;
            this.appEditUsers = yield mainApi.unitAppEditUsers(this.unitId, this.curApp.id, key, pageStart, pageSize);
            this.openVPage(VAppEditUsers);
        });
        this.onUserEditApps = (key) => __awaiter(this, void 0, void 0, function* () {
            let pageStart = 0;
            let pageSize = 100;
            this.userEditApps = yield mainApi.unitUserEditApps(this.unitId, this.curUser.id, key, pageStart, pageSize);
            this.openVPage(VUserEditApps);
        });
        this.bindAppUser = (user, checked) => __awaiter(this, void 0, void 0, function* () {
            yield mainApi.bindAppUser(this.unitId, this.curApp.id, user.id, checked === true ? 1 : 0);
        ...
        this.bindUserApp = (app, checked) => __awaiter(this, void 0, void 0, function* () {
            yield mainApi.bindAppUser(this.unitId, app.id, this.curUser.id, checked === true ? 1 : 0);
    ...
    internalStart(unitId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.openPage(React.createElement(Page, { header: "\u7528\u6237\u7BA1\u7406" },
                React.createElement(LMR, { className: cn, onClick: this.onAppUsers, left: appIcon }, "App\u7684\u7528\u6237"),
                React.createElement(LMR, { className: cn, onClick: this.onUserApps, left: userIcon }, "\u7528\u6237\u7684App")));
        });
    }
    loadAppUsers(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pageStart = 0;
            let pageSize = 100;
            let ret = yield mainApi.unitAppUsers(this.unitId, key, pageStart, pageSize);
            let apps = ret[0];
            let users = ret[1];
            let coll = {};
            for (let a of apps) {
    ...
    loadUserApps(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pageStart = 0;
            let pageSize = 100;
            let ret = yield mainApi.unitUsers(this.unitId, key, pageStart, pageSize);
            let users = ret[0];
            let apps = ret[1];
            let coll = {};
            for (let u of users) {
