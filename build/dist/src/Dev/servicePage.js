...
import { PropGrid, TonvaForm, Muted } from 'tonva';
    ...
    render() {
        ...
        let rows = [
            ...
            '',
            {
                ...
                name: 'url',
                label: 'URL',
                onClick: () => nav.push(React.createElement(StringValueEdit, { title: "\u4FEE\u6539URL", value: cur.url, onChanged: this.onUrlChanged, info: "\u597D\u7684\u540D\u5B57\u4FBF\u4E8E\u7406\u89E3" }))
            },
            {
                type: 'component',
                label: '服务器',
