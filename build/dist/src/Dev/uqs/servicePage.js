        ...
        this.page = () => {
            ...
            let rows = [
                ...
                '',*/
                {
                    ...
                    name: 'url',
                    label: 'URL',
                    onClick: () => nav.push(React.createElement(StringValueEdit, { title: "\u4FEE\u6539URL", value: this.service.url, onChanged: this.onUrlChanged }))
                },
                {
                    type: 'component',
                    label: '服务器',
                    component: React.createElement(ServerSpan, { id: this.service.server })
                },
                {
                    type: 'string',
                    name: 'db_type',
                    label: '数据库类型',
                    onClick: () => nav.push(React.createElement(StringValueEdit, { title: "\u6570\u636E\u5E93\u7C7B\u578B", value: this.service.db_type, onChanged: this.onDbTypeChanged }))
                },
                {
                    type: 'string',
                    name: 'db',
                    label: '数据库名',
                    onClick: () => nav.push(React.createElement(StringValueEdit, { title: "\u6570\u636E\u5E93\u540D\u5B57", value: this.service.db, onChanged: this.onDbChanged }))
                },
                {
                    type: 'string',
                    name: 'connection',
                    label: '连接字符串',
                    onClick: () => nav.push(React.createElement(TextValueEdit, { title: "\u8FDE\u63A5\u5B57\u7B26\u4E32", value: this.service.connection, onChanged: this.onConnectionChanged }))
                },
            ];
