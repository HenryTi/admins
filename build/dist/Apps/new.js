...
class PageApps extends PageItems {
    constructor(unitId) {
        super();
        this.unitId = unitId;
    }
...
let NewApp = class NewApp extends React.Component {
    ...
    renderApp(app) {
        ...
        return React.createElement(LMR, { className: "px-3 py-2", left: React.createElement(Badge, null,
                React.createElement(Image, { src: icon })), right: right },
    ...
    render() {
        ...
        return React.createElement(Page, { header: center },
            React.createElement(List, { items: items, item: { onClick: this.appClick, render: this.renderApp }, before: "\u641C\u7D22App\u540D\u5B57" }));
    }
};
NewApp = __decorate([
    observer
