...
import { CenterApi, appInFrame } from 'tonva-tools';
class MainApi extends CenterApi {
    ...
    unitUsers(unit, key, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/users', { unit: unit, key: key, pageStart: pageStart, pageSize: pageSize });
        });
    }
    unitAppUsers(unit, key, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/app-users', { unit: unit, key: key, pageStart: pageStart, pageSize: pageSize });
        });
    }
    unitOneAppUsers(unit, app, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/one-app-users', { unit: unit, app: app, pageStart: pageStart, pageSize: pageSize });
        });
    }
    unitOneUserApps(unit, user, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/one-user-apps', { unit: unit, user: user, pageStart: pageStart, pageSize: pageSize });
        });
    }
    unitAppEditUsers(unit, app, key, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/app-edit-users', { unit: unit, app: app, key: key, pageStart: pageStart, pageSize: pageSize });
        });
    }
    unitUserEditApps(unit, user, key, pageStart, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('unit/user-edit-apps', { unit: unit, user: user, key: key, pageStart: pageStart, pageSize: pageSize });
        });
    }
    bindAppUser(unit, app, user, bind) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.post('unit/bind-app-user', { unit: unit, app: app, user: user, bind: bind });
        });
    }
    userFromKey(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('tie/user-from-key', { key: key });
        });
    }
    unitAddUser(unit, user) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.post('unit/add-user', { unit: unit, user: user });
        });
    }
}
