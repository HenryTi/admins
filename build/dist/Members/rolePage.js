...
import { List, Media, LMR, FA, PropGrid } from 'tonva';
...
let RolePage = class RolePage extends React.Component {
    ...
    render() {
        ...
        if (count === undefined || count === null || count === 0) {
            membersLeft = React.createElement("small", { className: "text-muted" }, "\u65E0\u7528\u6237");
        }
        else {
            membersLeft = `共有 ${count} 用户`;
            membersRight = React.createElement("div", null,
        ...
        let rows = [
            ...
            {
                type: 'component',
                component: React.createElement(LMR, { className: "py-2", left: membersLeft, right: membersRight }),
                onClick: onMembersClick,
            },
            '=',
        ];
        let right = React.createElement("button", { className: "btn btn-success btn-sm", onClick: () => this.addRoleApp() },
        ...
        return React.createElement(Page, { header: "\u89D2\u8272", right: right },
            ...
            React.createElement("div", { className: "px-3 py-1" },
                React.createElement("small", null,
                    ...
                    " \u53EF\u7528APP\u5217\u8868")),
            React.createElement(List, { items: store.roleApps, item: { render: this.renderRoleApp, onClick: this.roleAppClick }, none: React.createElement("small", { className: "text-muted px-3 py-1" }, "\u6CA1\u6709APP, \u70B9\u51FB\u53F3\u4E0A\u89D2\u6309\u94AE\u9009\u62E9APP") }));
    }
};
RolePage = __decorate([
    observer
