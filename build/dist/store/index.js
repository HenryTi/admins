...
export class Store {
    ...
    loadAdminUnits() {
        return __awaiter(this, void 0, void 0, function* () {
            this.adminUnits = yield mainApi.userAdminUnits();
        });
    }
    loadUnit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.usqlServer = yield devApi.usqlServer();
    ...
    restoreUnitApp(appId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield mainApi.unitDeleteApp(this.unit.id, appId, 0);
            let app = this.apps.find(v => v.id === appId);
            app.inUnit = 1;
        });
    }
...
__decorate([
    observable
], Store.prototype, "adminUnits", void 0);
__decorate([
    observable
...
autorun(() => __awaiter(this, void 0, void 0, function* () {
    let user = nav.user;
    if (user === undefined) {
