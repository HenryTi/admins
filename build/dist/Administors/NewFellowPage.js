...
let NewFellowPage = class NewFellowPage extends React.Component {
    ...
    onSendInvitation(values) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret === undefined) {
                ...
                nav.replace(React.createElement(Page, { header: '完成', close: true },
    ...
    render() {
        ...
        let unitAdmins = store.admins.unitAdmins;
        let list = unitAdmins && unitAdmins.sort((a, b) => {
            if (a.isOwner === 1)
                if (b.isOwner === 1)
        ...
        return React.createElement(Page, { header: "新增管理成员" },
            React.createElement(Container, null,
                React.createElement(Row, null,
                    React.createElement(Col, { className: 'my-4 text-info' }, "\u8BF7\u8F93\u5165\u7528\u6237\u540D\uFF0C\u53D1\u9001\u9080\u8BF7\u3002\u7B49\u5F85\u5BF9\u65B9\u540C\u610F\u3002"))),
...
//# sourceMappingURL=NewFellowPage.js.map