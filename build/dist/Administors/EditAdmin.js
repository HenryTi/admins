...
let EditAdmin = class EditAdmin extends React.Component {
    ...
    componentWillMount() {
        ...
        if (isRoot === 1)
            this.schema = [owner, admin, submit];
        else if (isOwner === 1)
            this.schema = [admin, submit];
        this.uiSchema = {
            items: {
    ...
    render() {
        return React.createElement(Page, { header: '\u6743\u9650' },
            ...
            React.createElement(Form, { schema: this.schema, uiSchema: this.uiSchema, onButtonClick: this.onSubmit }));
    }
};
...
const Fellow = (props) => {
    ...
    return React.createElement("div", { className: "container" },
        React.createElement("div", { className: 'row my-4' },
            React.createElement("div", { className: "col-xs-2 d-flex justify-content-end align-items-start" },
