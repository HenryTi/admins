...
let AppLink = class AppLink extends React.Component {
    constructor(props) {
        super(props);
...
let AppInfo = class AppInfo extends React.Component {
    constructor(props) {
        super(props);
        this.apis = { label: '关联API', type: 'list', list: undefined, row: AppRow };
    }
    componentDidMount() {
...
class AppRow extends React.Component {
    render() {
        ...
        let disp;
        if (discription)
            disp = React.createElement("small", { className: "col-sm col-sm-auto text-muted" }, discription);
        return React.createElement("div", { className: 'row form-control-plaintext align-items-center' },
            React.createElement("div", { className: 'col' }, name),
            disp);
    }
}
