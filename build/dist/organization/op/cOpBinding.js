...
import { centerApi, entityIcons } from "tonva-react-usql";
// 单据跟操作的绑定设置
export class COpBinding extends Controller {
    constructor(unitxUsq) {
        ...
        this.appsView = () => React.createElement(Page, { header: this.label },
            React.createElement("div", { className: "text-dark p-3 pl-5 small" },
                React.createElement("div", null, "\u8BF4\u660E"),
                React.createElement("ol", { className: "pl-0", style: { listStyleType: '1', lineHeight: '1.8' } },
        ...
        this.pendingClick = (entityName) => {
            alert(entityName);
        };
        this.sheetClick = (sheet) => __awaiter(this, void 0, void 0, function* () {
            let entityPosts = this.unitxUsq.cFromName('query', 'getEntityPost');
        ...
        this.usqRender = (usq, index) => {
            ...
            function itemList(items, type, itemClick, render = nameRender) {
                ...
                return items &&
                    React.createElement(List, { className: "mt-3", header: headerCaption(type), items: items, item: { render: (item, index) => render(item, icon), onClick: itemClick } });
            }
            return React.createElement("div", { key: name, className: "my-2" },
                React.createElement("div", { className: "px-3 font-weight-blid" }, name),
    ...
    buildPosts() {
        return __awaiter(this, void 0, void 0, function* () {
            let queryAllTeams = this.unitxUsq.cFromName('query', 'allteams');
        ...
        for (let i = 0; i < len;) {
            switch (lns[i]) {
                ...
                case 'history':
                    ...
                    break;
                case 'pending':
                    p = this.setNames(usq.pendings = [], lns, i);
                    break;
                case 'query':
    ...
    saveSheetStatePosts(sheet, stateName, toArr) {
        return __awaiter(this, void 0, void 0, function* () {
            let actionSaveEntityOpPost = this.unitxUsq.cFromName('action', 'saveentityoppost');
            let { usq, name } = sheet;
