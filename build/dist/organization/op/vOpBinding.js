...
export class VOpBinding extends VPage {
    constructor() {
        super(...arguments);
        ...
        this.stateView = (state) => {
            ...
            */
            ...
            return React.createElement(Page, { header: `${this.sheet.name} - ${caption}`, back: "close", right: right },
    ...
    showEntry({ entity, opTos }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (states === undefined) {
                ...
                this.openPageElement(React.createElement(Page, { header: name + ' - 岗位' }, this.states.map(v => this.renderState(v))));
                return;
            }
...
//# sourceMappingURL=vOpBinding.js.map