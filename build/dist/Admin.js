...
export class VmAdmin extends VmPage {
    constructor() {
        ...
        this.onRowClick = (item) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.popPage();
            this.pushPage(React.createElement(AdminPage, null));
        });
    }
    loadAdminUnits() {
    ...
    show() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isProduction === false && this.adminUnits.length > 1) {
                this.pushPage(React.createElement(SelectUnit, { vm: this }));
            }
            else {
                this.pushPage(React.createElement(AdminPage, null));
            }
...
//@observer 
const SelectUnit = ({ vm }) => {
    let { adminUnits, renderRow, onRowClick } = vm;
    return React.createElement(Page, { header: "\u9009\u62E9\u5C0F\u53F7", logout: logout },
        React.createElement(List, { items: adminUnits, item: { render: renderRow, onClick: onRowClick } }));
};
            ...
            top = React.createElement(Container, null,
                React.createElement(Row, { className: 'my-4 bg-white py-1 cursor-pointer', onClick: () => nav.push(React.createElement(UnitProps, null)) },
                    React.createElement(Col, { xs: 2, className: 'd-flex justify-content-end align-items-start' },
                        React.createElement("img", { className: 'w-75', src: icon || appIcon })),
