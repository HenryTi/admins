...
let StartPage = class StartPage extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        if (adminUnits === undefined)
            return React.createElement(Page, null, "loading ... ");
        if (adminUnits.length === 1)
            return React.createElement(AdminPage, null);
        return React.createElement(SelectUnit, null);
    }
};
...
class SelectUnit extends React.Component {
    ...
    toAdminPage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            nav.pop();
            nav.push(React.createElement(AdminPage, null));
        });
    }
    ...
    render() {
        let { adminUnits } = store;
        return React.createElement(Page, { header: "\u9009\u62E9\u5C0F\u53F7" },
            React.createElement(List, { items: adminUnits, item: { render: this.renderRow, onClick: this.onRowClick } }));
    }
}
