    ...
    render() {
        ...
        if (files !== undefined && files.length > 0) {
            button = React.createElement("div", { className: "my-2 d-flex" },
                React.createElement(Button, { type: "submit", color: "success", onClick: this.update }, "\u4F18\u5316\u7F16\u8BD1"),
                React.createElement("div", { className: "py-2 flex-grow-1" }),
                React.createElement(Button, { type: "submit", onClick: this.updateThoroughly, color: "warning", outline: true }, "\u5B8C\u5168\u7F16\u8BD1"));
        }
