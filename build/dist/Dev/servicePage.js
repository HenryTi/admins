...
let NewService = class NewService extends React.Component {
    ...
    render() {
        return React.createElement(Page, { header: "\u65B0\u5EFAService" },
            React.createElement(TonvaForm, { className: "m-3", formRows: this.formRows, onSubmit: this.onSubmit }));
    }
};
...
let ServiceInfo = class ServiceInfo extends React.Component {
    ...
    render() {
        ...
        let right = React.createElement(Button, { onClick: this.onDeleteClick, color: "success" }, "\u5220\u9664");
