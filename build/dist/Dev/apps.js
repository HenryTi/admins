...
let Info = class Info extends React.Component {
    constructor() {
        super(...arguments);
        this.usqs = { label: '关联UQ', type: 'list', list: undefined, row: UsqRow };
    }
    componentWillMount() {
...
const appsProps = {
    ...
    info: Info,
    extraMenuActions: [
        { icon: 'cogs', caption: '设置关联UQ', action: () => nav.push(React.createElement(AppUqs, null)) }
    ],
};
let AppUqs = class AppUqs extends React.Component {
    ...
    render() {
        ...
        return React.createElement(Page, { header: "\u5173\u8054UQ" },
            React.createElement(List, { ref: this.ref, header: listHeader, items: store.dev.apps.uqs, item: { render: this.row, onSelect: this.onSelect } }));
    }
};
__decorate([
    observable
