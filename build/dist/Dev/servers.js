...
class Info extends React.Component {
    ...
    render() {
        ...
        let rows = [
            '',
            { type: 'component', component: React.createElement(Media, { icon: consts.appIcon, main: discription, discription: ip }) },
            '',
...
const serversProps = {
    ...
    row: (item) => {
        return React.createElement(Row, { icon: consts.appItemIcon, main: item.discription, vice: React.createElement(React.Fragment, null,
                item.cloud,
                "  ",
                item.ip) });
    },
